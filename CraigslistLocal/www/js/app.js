...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('auth.login', {
    url: '/login',
    templateUrl: "views/auth/logins.html",
    controller: 'LoginCtrl'
  })

  .state('auth.signup', {
    url: '/signup',
    templateUrl: "views/auth/signups.html",
  ...
  .state('app', {
    url: "/app",
    abstract: true,
    templateUrl: "views/app/side-menus.html",
    controller: 'AppCtrl'
  })
  ...
  .state('app.mapview', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/mapview.html",
  ...
  .state('app.category-feeds', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/feeds/category-feed.html",
  ...
  .state('app.newpost', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/posts/newpost.html",
  ...
  .state('app.profile', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/profiles.html"
      }
    }
  })
